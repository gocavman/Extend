...
public final class ExercisesState {
    ...
    private static func createDefaultExercises() -> [Exercise] {
        ...
        return [
            ...
            exercise(name: "Bulgarian Split Squats",primaryMuscleGroupIDs: [quadsID, glutesID],               secondaryMuscleGroupIDs: [hamstringsID],                equipmentIDs: [dumbbellID, benchID, noneID],                                                    hkType: .traditionalStrengthTraining),
            ...
            // G
            exercise(name: "Goblet Squat",          primaryMuscleGroupIDs: [quadsID, glutesID],               secondaryMuscleGroupIDs: [hamstringsID, absID],         equipmentIDs: [kettlebellID, dumbbellID],        defaultEquipmentIDs: [kettlebellID],           hkType: .traditionalStrengthTraining),
            ...
            exercise(name: "Lunges",                primaryMuscleGroupIDs: [quadsID, glutesID],               secondaryMuscleGroupIDs: [hamstringsID],                equipmentIDs: [dumbbellID, barbellID, noneID],                                               hkType: .traditionalStrengthTraining),
            ...
            exercise(name: "Rows",                  primaryMuscleGroupIDs: [latsID, rhomboidsID],             secondaryMuscleGroupIDs: [bicepsID, trapsID],           equipmentIDs: [barbellID, dumbbellID, kettlebellID],                                         hkType: .traditionalStrengthTraining),
